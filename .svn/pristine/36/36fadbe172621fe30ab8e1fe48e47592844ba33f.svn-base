...
//	public ResponseEntity<ServiceResult> emailCheck(@RequestBody AuditionUserVO userVO){
//		log.info("emailCheck->email : " + userVO.getApplicantEmail());
//		log.info("emailCheck->audiNo : " + userVO.getAudiNo());
//		ServiceResult result = auditionService.emailCheck(userVO);
